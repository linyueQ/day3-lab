...
接口: fund\_individual\_basic\_info\_xq
...
| 名称          | 类型  | 描述                                                                                                  |
| ----------- | --- | --------------------------------------------------------------------------------------------------- |
| symbol      | str | symbol='513500'; ETF 代码可以在 **ak.fund\_etf\_spot\_em()** 中获取                                         |
...
| 名称          | 类型  | 描述                                                                                                  |
| ----------- | --- | --------------------------------------------------------------------------------------------------- |
| symbol      | str | symbol='166009'; LOF 代码可以在 **ak.fund\_lof\_spot\_em()** 中获取                                         |
| start\_date | str | start\_date="1979-09-01 09:32:00"; 日期时间; 默认返回所有数据                                                   |
| end\_date   | str | end\_date="2222-01-01 09:32:00"; 日期时间; 默认返回所有数据                                                     |
| period      | str | period='5'; choice of {'1', '5', '15', '30', '60'}; 其中 1 分钟数据返回近 5 个交易日数据且不复权                       |
| adjust      | str | adjust=''; choice of {'', 'qfq', 'hfq'}; '': 不复权, 'qfq': 前复权, 'hfq': 后复权, 其中 1 分钟数据返回近 5 个交易日数据且不复权 |
...
| 名称          | 类型  | 描述                                                                 |
| ----------- | --- | ------------------------------------------------------------------ |
| symbol      | str | symbol='159707'; ETF 代码可以在 **ak.fund\_etf\_spot\_em()** 中获取或查看东财主页 |
| period      | str | period='daily'; choice of {'daily', 'weekly', 'monthly'}           |
| start\_date | str | start\_date='20000101'; 开始查询的日期                                    |
| end\_date   | str | end\_date='20230104'; 结束查询的日期                                      |
...
| 名称     | 类型  | 描述                                                                                                         |
| ------ | --- | ---------------------------------------------------------------------------------------------------------- |
| symbol | str | symbol="sh510050"; 基金列表可以通过 **ak.fund\_etf\_category\_sina(symbol="LOF基金")** 可选参数为: 封闭式基金, ETF基金, LOF基金 查询 |
...
接口: fund\_open\_fund\_daily\_em
...
| 名称        | 类型  | 描述                                                                                             |
| --------- | --- | ---------------------------------------------------------------------------------------------- |
| symbol    | str | symbol="710001"; 需要基金代码, 可以通过调用 **ak.fund\_open\_fund\_daily\_em()** 获取                        |
| indicator | str | indicator="单位净值走势";  参见 **fund\_open\_fund\_info\_em** 参数一览表                                   |
| period    | str | period="成立来"; 该参数只对 `累计收益率走势` 有效, choice of {"1月", "3月", "6月", "1年", "3年", "5年", "今年来", "成立来"} |

fund\_open\_fund\_info\_em 参数一览表
...
接口: fund\_money\_fund\_daily\_em
...
接口: fund\_money\_fund\_info\_em
...
| 名称     | 类型  | 描述                                                                       |
| ------ | --- | ------------------------------------------------------------------------ |
| symbol | str | symbol="000009"; 需要基金代码, 可以通过调用 **ak.fund\_money\_fund\_daily\_em()** 获取 |
...
接口: fund\_financial\_fund\_daily\_em
...
接口: fund\_financial\_fund\_info\_em
...
| 名称     | 类型  | 描述                                                                         |
| ------ | --- | -------------------------------------------------------------------------- |
| symbol | str | symbol="000134"; 基金代码, 可以通过调用 **ak.fund\_financial\_fund\_daily\_em()** 获取 |
...
接口: fund\_graded\_fund\_daily\_em
...
接口: fund\_graded\_fund\_info\_em
...
| 名称     | 类型  | 描述                                                                        |
| ------ | --- | ------------------------------------------------------------------------- |
| symbol | str | symbol="150232"; 需要基金代码, 可以通过调用 **ak.fund\_graded\_fund\_daily\_em()** 获取 |
...
| 名称          | 类型  | 描述                                                                 |
| ----------- | --- | ------------------------------------------------------------------ |
| fund        | str | fund="511280"; 基金代码, 可以通过调用 **ak.fund\_etf\_fund\_daily\_em()** 获取 |
| start\_date | str | start\_date="20000101"; 开始时间                                       |
| end\_date   | str | end\_date="20500101"; 结束时间                                         |
...
| 名称     | 类型  | 描述                                                               |
| ------ | --- | ---------------------------------------------------------------- |
| code   | str | code="1002200683"; 香港基金代码, 可以通过调用 **ak.fund\_em\_hk\_rank()** 获取 |
...
接口: fund\_individual\_achievement\_xq
...
接口: fund\_value\_estimation\_em
...
接口: fund\_individual\_analysis\_xq
...
接口: fund\_individual\_profit\_probability\_xq
...
接口: fund\_individual\_detail\_hold\_xq
...
接口: fund\_individual\_detail\_info\_xq
...
| 名称     | 类型  | 描述                                                         |
| ------ | --- | ---------------------------------------------------------- |
| symbol | str | symbol="000001"; 基金代码, 可以通过调用 **ak.fund\_name\_em()** 接口获取 |
...
接口: fund\_portfolio\_bond\_hold\_em
...
接口: fund\_portfolio\_industry\_allocation\_em
...
接口: fund\_portfolio\_change\_em
...
| 名称        | 类型  | 描述                                                         |
| --------- | --- | ---------------------------------------------------------- |
| symbol    | str | symbol="003567"; 基金代码, 可以通过调用 **ak.fund\_name\_em()** 接口获取 |
...
接口: fund\_scale\_structured\_sina
...
接口: fund\_report\_stock\_cninfo
...
接口: fund\_report\_industry\_allocation\_cninfo
...
接口: fund\_report\_asset\_allocation\_cninfo
...
接口: fund\_balance\_position\_lg
...
接口: fund\_linghuo\_position\_lg
...
接口: fund\_announcement\_dividend\_em
...
| 名称     | 类型  | 描述                                   |
| ------ | --- | ------------------------------------ |
| symbol | str | 基金代码，可以通过调用 ak.fund\_name\_em() 接口获取 |
...
接口: fund\_announcement\_report\_em
...
接口: fund\_announcement\_personnel\_em
